...
/*
  ...
  */
  ...
  //pcl::io::savePLYFileASCII("output/road.ply",*final);
  //pcl::io::savePLYFileASCII("output/point_xyzRGBcloud_ptr.ply",*point_xyzRGBcloudFiltered_ptr);
